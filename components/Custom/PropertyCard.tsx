        ...
        <div className="relative overflow-hidden h-[230px]">
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent
                side="right"
                className="bg-space-darkgreen text-space-greens"
              >
                {isFavorite ? "Added to favorites" : "Add to favorites"}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
          <Badge className="absolute top-4 py-1 px-3 right-4 bg-space-darkgreen text-space-greens z-10">
            {property.status}
          </Badge>
        </div>
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="flex items-center text-gray-500">
                ...
                <span className="text-sm text-space-blacks">
                  {property.location}
                </span>
              </div>
            </div>
            ...
            <div className="flex justify-between items-center pt-2 font-inter">
              <div className="flex items-center gap-4 text-gray-600">
                <div className="flex items-center gap-1 border-[0.8px] border-gray-400 rounded-2xl px-3 py-1">
                  ...
                  <span className="text-sm font-semibold text-space-blacks">
