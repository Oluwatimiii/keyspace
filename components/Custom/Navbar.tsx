          ...
          <div className="hidden md:ml-6 md:flex md:items-center">
            {user ? (
              <div className="flex items-center space-x-4">
                ...
                <DropdownMenu>
                  <DropdownMenuTrigger asChild>
                    <Button
                      size="sm"
                      className="flex items-center gap-2 bg-space-greens hover:bg-space-fades transition-colors duration-150"
                    >
                  ...
                  <DropdownMenuContent className="w-56" align="end">
                    <DropdownMenuLabel>
                      <div className="flex flex-col space-y-1">
                        <p className="text-sm font-semibold leading-none text-space-darkgreen">
                          {user?.user_metadata?.name || "User Name"}
                        </p>
                        <p className="text-xs leading-none font-urbanist text-space-blacks/40">
                    ...
                    <DropdownMenuItem className="text-red-600 focus:text-red-600">
                      <Button
                        ...
                        className="flex items-center w-full bg-space-darkgreen"
                      >
              ...
              <div className="space-x-3 flex items-center">
                <Button
                  asChild
                  className="bg-transparent text-white hover:text-space-greens rounded-full"
                >
                  <Link href="/contact">Contact Us</Link>
                </Button>
                <Button
                  asChild
                  className="bg-space-greens text-space-blacks hover:text-space-greens rounded-full"
                >
                  ...
                  <div className="px-3 py-2 rounded-md bg-gray-900/5">
                    <div className="flex items-center space-x-3">
                      <div className="flex-shrink-0">
                        <User className="h-8 w-8" color="white" />
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="text-sm font-medium text-slate-300">
                          {user?.user_metadata?.name || "User Name"}
                        </p>
                        <p className="text-sm text-space-greens truncate">
                          {user?.email || "user@example.com"}
                        </p>
                      </div>
                    </div>
